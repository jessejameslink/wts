...
<script>
	$(document).ready(function() {
		document.title = "MIRAE ASSET VN | Newsletter Registration";
	});
</script>
</head>
<body>
    ...
    <div class="sub_container">
        ...
        <div id="lnb" class="lnb">
            ...
            <ul>
                ...
                -->
                <li><a href="/home/derivaties/registernews.do" class="on">Newsletter Registration</a></li>
            </ul>
        </div>
        <!-- // lnb -->

        <div id="contents">
            <h3 class="cont_title">Newsletter Registration</h3>
