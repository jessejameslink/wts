    ...
    <div class="sub_container">
        ...
        <div id="contents">
            ...
            <div class="bottom_btns">
                <input type="button" class="btn" value="Back" onclick="vacanciesView()"/>
            </div>
            -->
            <div style="padding-left:30px;">
            	<a style="cursor: pointer;" onclick="vacanciesView()"><img src="/resources/US/images/icon_back.png" alt="Back"></a>
            </div>
        </div>
    </div>
</div>
