...
<html>
  ...
  @media screen and (max-width: 485px) {
    ...
    .primary-text-color {
      color: rgba(4, 68, 124, 1) !important;
    }

    .secondary-text-color {
      color: rgba(241, 151, 45, 1) !important;
    }
    ...
    .border-button {
      color: rgba(92, 140, 172, 1) !important;
      border-color: rgba(92, 140, 172, 1) !important;
    }
    .button {
      background-color: rgba(92, 140, 172, 1) !important;
      color:  !important;
    }
