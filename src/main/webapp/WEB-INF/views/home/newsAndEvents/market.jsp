				...
				if(list != null) {
					...
					if(list != null && list.length > 0) {
						for(var i=0; i < list.length; i++) {
							...
							htmlStr += "	<td class=\"headline\"><a href=\"/home/newsAndEvents/market_view.do?lang=en&sid=" + stockNewsList.articleId + "\" onclick=\"miraeAllView('"+stockNewsList.articleId+"');return false;\" style=\"cursor: pointer;\">" + stockNewsList.title + "</a></td>"; // Title
							htmlStr += "</tr>";
						}
...
<div id="container" class="sub">
    ...
    <div class="sub_container">
        ...
        <div id="contents">
            ...
            <div class="tab">
                <div>
                    <a style="cursor: pointer;" onclick="marketGo('/home/newsAndEvents/market.do')" class="on">All Market</a>
                ...
                <form action="">
                    <fieldset class="search_wrap">
                        ...
                        <div class="keyword">
                            ...
                            <input type="button" value="Search" class="btn_search" onclick="getMarketAllNewsList()"/>
                        </div>
