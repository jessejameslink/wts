...
<script>
	$(document).ready(function() {
		document.title = "MIRAE ASSET VN | Tin tức";
	});
</script>
</head>
<body>
    ...
    <div class="sub_container">
        ...
        <div id="lnb" class="lnb">
            ...
            <ul>
                ...
                <li><a href="/home/derivaties/indexseries.do">HĐ tương lai chỉ số</a></li>
                ...
                <li><a href="/home/derivaties/derinews.do" class="on">Tin tức</a></li>
        ...
        <div id="contents">
            <h3 class="cont_title">Tin tức</h3>
