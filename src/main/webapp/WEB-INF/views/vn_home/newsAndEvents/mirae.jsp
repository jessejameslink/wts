...
<script>
	...
	function miraeNewsDetailView(sid) {
		...
		//$("#frmMiraeView").submit();
		location.href="/home/newsAndEvents/mirae_view.do?lang=vi&sid=" + sid + "&from=" + $("#mvStartDate").val() + "&to=" + $("#mvEndDate").val() + "&key=" + $("#searchKey").val() + "&page=" + page;
	}
        ...
        <div id="lnb" class="lnb">
            ...
            <ul>
                <li>
                    ...
                    <ul class="lnb_sub">
                        <li><a href="/home/newsAndEvents/mirae.do" class="on">Tin Mirae Asset</a></li>
