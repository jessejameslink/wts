...
<script>
	...
	$(document).ready(function() {
		...
		if("${type}" == null || "${type}" == "") {
			...
			$("#fromDate").datepicker("setDate", d.getDate() + "/" + (d.getMonth() + 1) + "/" + d.getFullYear());
			$("#searchKey").val('');
			getMarketAllNewsList();
		} else {
			$("#fromDate").val("${from}");
			$("#toDate").val("${to}");
			...
			//}
			//$("#trPage").val(trPage);
			getMarketAllNewsList("${trPage}");
		}
	});
	
	
	
	function getMarketAllNewsList(page) {
				...
				if(list != null) {
					...
					if(list != null && list.length > 0) {
						for(var i=0; i < list.length; i++) {
							...
							htmlStr += "	<td class=\"headline\"><a href=\"/home/newsAndEvents/market_view.do?lang=vi&sid=" + stockNewsList.articleId + "\" onclick=\"miraeAllView('"+stockNewsList.articleId+"');return false;\" style=\"cursor: pointer;\">" + stockNewsList.title + "</a></td>"; // Title
							htmlStr += "</tr>";
						}
						$("#grdMarketAllNews").html(htmlStr);
...
<div id="container" class="sub">
    ...
    <div class="sub_container">
        ...
        <div id="contents">
            ...
            <div class="tab">
                <div>
                    <a style="cursor: pointer;" onclick="marketGo('/home/newsAndEvents/market.do')" class="on">Toàn thị trường</a>
                ...
                <form action="">
                    <fieldset class="search_wrap">
                        ...
                        <div class="keyword">
                            ...
                            <input type="button" value="Tìm kiếm" class="btn_search" onclick="getMarketAllNewsList()"/>
                        </div>
