...
<div id="container" class="sub">
    <div class="sub_container">
        ...
        <div id="lnb" class="lnb">
            <h2>Phân tích</h2>
            <ul>
                <li><a href="/home/subpage/research.do">Báo cáo thường nhật</a></li>
                <li><a href="/home/subpage/sector.do" class="on">Ngành / Doanh nghiệp</a></li>
                <li><a href="/home/subpage/macro.do">Vĩ mô / Chiến lược</a></li>
            </ul>
        </div>
        <!-- // lnb -->
        <div id="contents">
            <h3 class="cont_title">Ngành / Doanh nghiệp</h3>
            <div class="search">
                <form action="">
