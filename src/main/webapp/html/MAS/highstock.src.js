...
(function () {
   ...
   if (!hasSVG && !useCanVG) {
      ...
      VMLElement = {
         ...
         // VMLElement.strokeSetter	> setAttr 84.01ms
         setAttr: function (key, value) {
            if (docMode8) { // IE8 setAttribute bug
               this.element[key] = value;
               //               this.element.ie8_setAttribute(key, value);
            } else {
				...
				//setTimeout(function(){
					...
					if(that.chart) {
						...
						that.render();
						 ...
						 each(that.plotLinesAndBands, function (plotLine) {
							plotLine.render();
						 });

						 // mark associated series as dirty and ready for redraw
						 each(that.series, function (series) {
							series.isDirty = true;
						 });
					}
				//},50);
   ...
   Chart.prototype = {
      ...
      getContainer: function () {
         ...
         chart.container = container = createElement(DIV, {
               ...
               position: RELATIVE,
               //2016占쏙옙3占쏙옙25占쏙옙占쎈벡湲쏙옙占쏙옙���(Tooltip 占쎈���옙占썸�占쎌� 占쎌���
   ...
   var OHLCSeries = extendClass(seriesTypes.column, {
      ...
      getAttribs: function () {
         ...
         //=== modify: 20140625 繹�옙��㎗占쏙옙�쎈�揶�옙爰썸�占썽���옙揶�옙揶�����占�qColor占쏙옙占쎌�以�占쎌���===//
         var eqPointAttr = merge(series.pointAttr),
            eqColor = options.eqColor || 'black';

         eqPointAttr[''][upColorProp] = eqColor;
         eqPointAttr.hover[upColorProp] = eqColor;
         eqPointAttr.select[upColorProp] = eqColor;
         /////////////////////////////////////////////////////////////////
   ...
   var CandlestickSeries = extendClass(OHLCSeries, {
      ...
      getAttribs: function () {
         ...
         each(series.points, function (point) {
            ...
            //=== modify: 20140625 繹�옙��㎗占쏙옙�쎈�揶�옙爰썸�占썽���옙揶�옙揶�����占�qColor 占쎈���에占쏙옙��� ===//
            else if (point.open == point.close) {
               point.pointAttr[''].stroke = options.eqColor || 'black';
            }
            //=======================================================//
         });
      },
   ...
   Scroller.prototype = {
      ...
      addEvents: function () {
         ...
         if (hasTouch) {
            _events.push(
               [container, 'touchstart', mouseDownHandler], [container, 'touchmove', mouseMoveHandler], [document, 'touchend', mouseUpHandler]
            );
         }
   ...
   Point.prototype.tooltipFormatter = function (pointFormat) {
      ...
      pointFormat = pointFormat.replace(
         '{point.change}', (point.change > 0 ? '+' : '') + Highcharts.numberFormat(point.change, pick(point.series.tooltipOptions.changeDecimals, 2))
      );
