...
public class StringDecrypter {
	 ...
	 * @throws Exception
	 */
	public StringDecrypter(String key, String initialVector) throws Exception {
	...
	public String decrypt(byte[] value){
		try{
			if (value == null)				throw new Exception("The cipher string can not be null or an empty string.");
			// Initialize the cryptography algorithm.
			this.rijndael.init(Cipher.DECRYPT_MODE, this.key, this.initalVector);
			// Decrypt the byte array.
