    ...
    <div class="sub_container">
        ...
        <div id="lnb" class="lnb">
            ...
            <ul>
                ...
                <li><a href="/home/support/motp.do" class="on">M-OTP</a></li>
        ...
        <div id="contents">
            <h3 class="cont_title">Hướng dẫn đăng ký M-OTP</h3>

            <div class="trading_guide web">
                <div class="guideline">
                    <p>Hướng dẫn đăng ký M-OTP</p>
                    <!--  
                    <a href="#" onclick="downloadFile(2);return false;">Tải về</a>
                    -->
                    <a href="https://masvn.com/linkDown.do?ids=EBBA417E-1832-4890-8AA2-4770CE91A16A">Tải về</a>                    
                </div>
               <!--  <div class="guideline">
