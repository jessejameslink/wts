				...
				if(list != null) {
					...
					if(list != null && list.length > 0) {
						for(var i=0; i < list.length; i++) {
							...
							htmlStr += "	<td class=\"headline\"><a href=\"/home/newsAndEvents/market_view.do?lang=vi&sid=" + stockNewsList.articleId + "\" onclick=\"miraeHoseView('"+stockNewsList.articleId+"');return false;\" style=\"cursor: pointer;\">" + stockNewsList.title + "</a></td>"; // Title
							htmlStr += "</tr>";
						}
                ...
                <form action="">
                    <fieldset class="search_wrap">
                        ...
                        <div class="keyword">
                            ...
                            <input type="button" value="Tìm kiếm" class="btn_search" onclick="searchMarketHoseNewsList()"/>
                        </div>
