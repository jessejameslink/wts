...
<script>
	$(document).ready(function() {
		document.title = "MIRAE ASSET VN | Phân tích";
		var d = new Date();
		...
		$.ajax({
			...
			success   : function(data) {
				...
				if(data.jsonObj != null && data.jsonObj.listSize != 0){
					...
					researchListStr += "<tr><td class=\"no_result\" colspan=\"3\">Không tìm thấy dữ liệu</td></tr>";
			 	}
				// 리스트 세팅
...
<div id="container" class="sub">
    <div class="sub_container">
        ...
        <div id="lnb" class="lnb">
            <h2>Phân tích</h2>
            <ul>
                <li><a href="/home/subpage/research.do" class="on">Báo cáo thường nhật</a></li>
                <li><a href="/home/subpage/sector.do">Ngành / Doanh nghiệp</a></li>
                <li><a href="/home/subpage/macro.do">Vĩ mô / Chiến lược</a></li>
            </ul>
        </div>
        <!-- // lnb -->
        <div id="contents">
            <h3 class="cont_title">Báo cáo thường nhật</h3>
            <div class="search">
                <form action="">
                    <fieldset class="search_wrap">
						...
						<div class="keyword">
                            ...
                            <input type="button" value="Tìm kiếm" class="btn_search" onclick="getResearchList();">
                        </div>
                        <div class="date">
                            <span class="date_box">
