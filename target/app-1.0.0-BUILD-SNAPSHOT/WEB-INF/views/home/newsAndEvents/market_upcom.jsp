				...
				if(data.stockNewsList != null) {
					...
					if(data.stockNewsList.list1 != null && data.stockNewsList.list1.length > 0) {
						for(var i=0; i < data.stockNewsList.list1.length; i++) {
							...
							htmlStr += "	<td class=\"headline\"><a href=\"/home/newsAndEvents/market_view.do?lang=en&sid=" + stockNewsList.seqn + "\" onclick=\"miraeUpcomView('"+stockNewsList.seqn+"');return false;\" style=\"cursor: pointer;\">" + stockNewsList.titl + "</a></td>"; // Title
							htmlStr += "</tr>";
						}
                ...
                <form action="">
                    <fieldset class="search_wrap">
                        ...
                        <div class="keyword">
                            ...
                            <input type="button" value="Search" class="btn_search" onclick="searchMarketUpcomNewsList()"/>
                        </div>
