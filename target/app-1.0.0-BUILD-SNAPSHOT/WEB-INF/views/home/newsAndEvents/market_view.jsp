    ...
    <div class="sub_container">
            ...
            <ul>
                <li>
                    ...
                    <ul class="lnb_sub">
                        ...
                        <li><a style="cursor: pointer;" onclick="marketView()" class="on">Market News</a></li>
                    </ul>
                </li>
        ...
        <div id="contents">
            ...
            <div class="bottom_btns">
                <input type="button" class="btn" value="Back" onclick="marketView()"/>
            </div>
            -->
            <div style="padding-left:30px;">
            	<a style="cursor: pointer;" onclick="marketView()"><img src="/resources/US/images/icon_back.png" alt="Back"></a>
            </div>
        </div>
    </div>
</div>
