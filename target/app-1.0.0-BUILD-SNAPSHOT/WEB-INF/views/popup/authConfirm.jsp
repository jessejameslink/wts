			...
			success   : function(data) {
				...
				if(data != null) {
					if(data.jsonObj.mvSuccess == "FAIL") {
						...
						$("#<%=request.getParameter("divId")%> #divAuthLayer #divAuth").css("display","block");
						$("#<%=request.getParameter("divId")%> #divAuthLayer #divAuthMsg").css("display","none");
						...
						if(data.jsonObj.mvClientCardBean.mvErrorCode == "SERVER_ERROR"){
							$("#<%=request.getParameter("divId")%> #divAuthLayer #divAuth").css("display","none");
							$("#<%=request.getParameter("divId")%> #divAuthLayer #btnAuthConfirm").css("display","none");
						}
					} else if(data.jsonObj.mvSuccess == "SUCCESS") {
						
						$("#<%=request.getParameter("divId")%> #divAuthLayer #divAuthMsg").css("display","block");
						$("#<%=request.getParameter("divId")%> #divAuthLayer #divAuth").css("display","none");
